# ------------------------------------------
# CDCD for dance-to-music task on TikTok dataset
# written By Ye Zhu
# ------------------------------------------
        ...
        **kwargs,
        ...
        if return_rec:
            ...
            for k in range(batch_size):
                ...
                recons_sample = '/home/zhuye/VQ-Diffusion_d2m/tiktok_audios/' + recons_sample
        ...
        for fr in filter_ratio:
            for cr in content_ratio:
                ...
                for k in range(batch_size):
                    ...
                    sample_audio = '/home/zhuye/VQ-Diffusion_d2m/tiktok_audios/' + sample_audio
