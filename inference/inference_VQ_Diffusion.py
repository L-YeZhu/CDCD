...
if __name__ == '__main__':
    ...
    VQ_Diffusion = VQ_Diffusion('/data/zhuye/D2M-Diffusion/models/aist_top.yaml', path='/data/zhuye/D2M-Diffusion/aist_train_inter_sample_t100/checkpoint/last.pth')
    ...
    for i, f in enumerate(testing_music):
        ...
        # file_audio = os.path.join('/home/zhuye/VQ-Diffusion/RESULT', file_audio)
        # sf.write(file_audio, generated_audio, 22050)
